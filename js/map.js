...
import {getType} from '/js/util.js'
import {getEndingGuests} from '/js/util.js'
import {getEndingRooms} from '/js/util.js'
import {getFeaturesList} from '/js/util.js'
...
const createCustomPopup = ({author, offer})=>{
  ...
  let description =popupElement.querySelector('.popup__description')
  ...
  let photosList =popupElement.querySelector('.popup__photos')
